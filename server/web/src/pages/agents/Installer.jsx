            ...
            <div className="result-box">
              {result.downloadUrl ? (
                ...
                <p style={{ color: 'var(--text-muted)' }}>
                  No MSI found on server.{' '}
                  <a href="https://github.com/rcobb2/OpenStats#building-installers" target="_blank" rel="noreferrer">
      ...
      {tab === 'mac' && (
        <div>
          ...
          <div className="result-box">
            ...
            <p>
              <a href={macDownloadURL} download>Download latest macOS .pkg</a>
            </p>
...
sudo launchctl bootstrap system /Library/LaunchDaemons/com.openlabstats.agent.plist`}</code></pre>
            ...
            <h3>Self-Update</h3>
            <p>
              Once enrolled, agents update automatically. When you upload a new .pkg to the server
              and set the minimum agent version in <strong>Settings</strong>, outdated agents will
              download and install the update on their next heartbeat — no manual intervention needed.
